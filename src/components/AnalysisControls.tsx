...
const INSTRUMENT_VAR: Record<Instrument, string> = {
  hihat: '--hihat',
  snare: '--snare',
  kick: '--kick',
};
  ...
  return (
    <div className="controls">
      <div className="controls__section">
        <p className="controls__section-title">テンポ</p>
      ...
      <div className="controls__section">
        <p className="controls__section-title">拍子とグリッド</p>
        <div className="controls__row">
          <label className="field">
            <span>開始位置のずれ (秒)</span>
            <input
      ...
      <div className="controls__section">
        <p className="controls__section-title">検出感度</p>
